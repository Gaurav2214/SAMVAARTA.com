...
document.addEventListener("readystatechange", function (event) {
  ...
  if (event.target.readyState === "complete") {
    unvielImg();
    setTimeout(function () {
      var _oauthUserData13;
      if (Samvaarta.globalVar.is_loggedin) {
        var _oauthUserData12;
        ...
        if (((_oauthUserData12 = oauthUserData) === null || _oauthUserData12 === void 0 ? void 0 : _oauthUserData12.user_type) === 'admin') {
          Samvaarta.system.enquiriesDetail();
        }
      }
      if ($('.deep-user-route').length && ((_oauthUserData13 = oauthUserData) === null || _oauthUserData13 === void 0 ? void 0 : _oauthUserData13.user_type) !== 'user') {
