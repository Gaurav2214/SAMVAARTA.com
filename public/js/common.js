...
function convertTextWithLineBreaks(text) {
...
Samvaarta.system = function () {
  ...
  var forgetPassModule = function forgetPassModule() {
    ...
    $('body').on('click', '.forget_password', function () {
      $(".login-module__main--right").length ? document.querySelector(".login-module__main--right").innerHTML = forgetPass : '';
      showFormToggle();
    });
  };
  ...
  var editProfile = function editProfile() {
    var _getOuathData$data$da, _getOuathData, _getOuathData2, _getOuathData3, _getOuathData4, _getOuathData5, _getOuathData6, _getOuathData7, _getOuathData8, _getOuathData9, _getOuathData10, _getOuathData11;
  ...
  var displayTypeWise = function displayTypeWise(response, type) {
    ...
    response.map(function (item, index) {
      ...
      if (type === 'users') {
        ...
        viewDetails = "<a href=\"/dashboard/trainer-details/".concat(item.id, "\">View Details</a>");
      }
...
Samvaarta.userDashboard = function () {
  ...
  var closureInteraction = function closureInteraction(response, trainerRes) {
    var _response$, _response$2, _response$3, _response$4, _response$5, _response$6, _trainerRes$, _trainerRes$2;
    ...
    $('#manager_enjoyed').val((_trainerRes$ = trainerRes[0]) === null || _trainerRes$ === void 0 ? void 0 : _trainerRes$.experience_enjoyed);
    $('#manager_wished').val((_trainerRes$2 = trainerRes[0]) === null || _trainerRes$2 === void 0 ? void 0 : _trainerRes$2.experience_wish);
  };
  ...
  var displaySessionList = function displaySessionList(response) {
    ...
    response === null || response === void 0 || (_response$data2 = response.data) === null || _response$data2 === void 0 || _response$data2.data.map(function (item, index) {
      var _item$trainer2, _item$trainer3, _Samvaarta$common$get, _Samvaarta$common$get2;
      sessionList += "\n                <tr>\n                    <td>".concat(index + 1, "</td>\n                    <td>").concat(item.session_date.split(' ')[0], "</td>\n                    <td>").concat(item.topic, "</td>\n                    <td>").concat(item.duration, "</td>\n                    <td>").concat(item !== null && item !== void 0 && (_item$trainer2 = item.trainer) !== null && _item$trainer2 !== void 0 && _item$trainer2.name ? item === null || item === void 0 || (_item$trainer3 = item.trainer) === null || _item$trainer3 === void 0 ? void 0 : _item$trainer3.name : (_Samvaarta$common$get = Samvaarta.common.getLocalStorage('oauthUserData')) !== null && _Samvaarta$common$get !== void 0 && (_Samvaarta$common$get = _Samvaarta$common$get.data) !== null && _Samvaarta$common$get !== void 0 && _Samvaarta$common$get.trainer ? (_Samvaarta$common$get2 = Samvaarta.common.getLocalStorage('oauthUserData').data) === null || _Samvaarta$common$get2 === void 0 || (_Samvaarta$common$get2 = _Samvaarta$common$get2.trainer[0]) === null || _Samvaarta$common$get2 === void 0 ? void 0 : _Samvaarta$common$get2.name : '', "</td>\n                </tr>\n            ");
    });
...
Samvaarta.setGetUserDashboard = function () {
  ...
  var previousTransactions = function previousTransactions(response) {
    ...
    if (response !== null && response !== void 0 && (_response$data5 = response.data) !== null && _response$data5 !== void 0 && _response$data5.length) {
      ...
      response === null || response === void 0 || response.data.map(function (item, index) {
        var _item$session, _item$session2, _item$session3, _item$session4, _oauthUserData2, _oauthUserData3, _oauthUserData4, _item$session5, _item$session6, _oauthUserData5, _oauthUserData6, _oauthUserData7, _item$session7;
        if (item.doc_file) {
  ...
  var getDocConversation = function getDocConversation() {
    ...
    var ajaxSuccessCall = function ajaxSuccessCall(response) {
      var _response$data8;
      if ((response === null || response === void 0 || (_response$data8 = response.data) === null || _response$data8 === void 0 ? void 0 : _response$data8.success) === 'true') {
        previousTransactions(response === null || response === void 0 ? void 0 : response.data);
        Samvaarta.common.setLocalStorage('DocConversationDetail', response === null || response === void 0 ? void 0 : response.data, expireTime);
      } else {
        $('.previous-transactions').html('<p>No previous interactions</p>');
      }
    };
  ...
  var qualitativeData = function qualitativeData(response) {
    var qualityData = '';
    for (var i = 0; i < 3; i++) {
      qualityData += "\n            <tr>\n                <td>\n                    <input ".concat(response !== null && response !== void 0 && response.parameter && (response === null || response === void 0 ? void 0 : response.status) !== 2 ? 'readonly' : '', " id=\"qualitative_param_").concat(i + 1, "\" class=\"input_txt_box\" type=\"text\" value=\"").concat(response !== null && response !== void 0 && response.parameter ? response === null || response === void 0 ? void 0 : response.parameter[i] : '', "\" />\n                    <p id=\"qualitative_param_").concat(i + 1, "_err\" class=\"error\"></p>\n                </td>\n                <td>\n                    <textarea ").concat(response !== null && response !== void 0 && response.description && (response === null || response === void 0 ? void 0 : response.status) !== 2 ? 'readonly' : '', " id=\"qualitative_desc_").concat(i + 1, "\" class=\"input_txt_box\" type=\"text\" value=\"\" ></textarea>\n                    <p id=\"qualitative_desc_").concat(i + 1, "_err\" class=\"error\"></p>\n                </td>\n            </tr>\n            <script>\n                $('#qualitative_desc_").concat(i + 1, "').val(\"").concat(response !== null && response !== void 0 && response.description ? response === null || response === void 0 ? void 0 : response.description[i] : '', "\");\n            </script>\n            ");
    }
  ...
  var desiredOutcomesStatus = function desiredOutcomesStatus(status, id) {
    var paramObject = {
  ...
  var desiredObjectiveStatus = function desiredObjectiveStatus(status, id) {
    var paramObject = {
...
Samvaarta.deepDisplayUser = function (_window$location, _window$location$path) {
  ...
  var displayUserDetails = function displayUserDetails() {
    var _oauthUserData8, _oauthUserData9;
    var deepDis = '';
    if (((_oauthUserData8 = oauthUserData) === null || _oauthUserData8 === void 0 ? void 0 : _oauthUserData8.user_type) === 'trainer') {
    ...
    } else if (((_oauthUserData9 = oauthUserData) === null || _oauthUserData9 === void 0 ? void 0 : _oauthUserData9.user_type) === 'admin') {
      var userData = Samvaarta.common.getLocalStorage('deepUserData');
      var _response = userData === null || userData === void 0 ? void 0 : userData.data;
      if ((_response === null || _response === void 0 ? void 0 : _response.user_type) === 'user') {
        var _Samvaarta, _response$trainer$3;
        deepDis = "\n                        <div class=\"show-user-details__inner\">\n                            <div class=\"show-user-details__inner--left detail-items\">\n                                <ul>\n                                <li>Code: <span>".concat(_response !== null && _response !== void 0 && _response.unique_number ? _response === null || _response === void 0 ? void 0 : _response.unique_number : _response === null || _response === void 0 ? void 0 : _response.id, "</span></li>\n                                <li>Name: <span>").concat(_response !== null && _response !== void 0 && _response.name ? _response === null || _response === void 0 ? void 0 : _response.name : '', "</span></li>\n                                    <li>Date of Joining: <span>").concat((_Samvaarta = Samvaarta) === null || _Samvaarta === void 0 || (_Samvaarta = _Samvaarta.common) === null || _Samvaarta === void 0 ? void 0 : _Samvaarta.dateMonthYear(_response === null || _response === void 0 ? void 0 : _response.created_at), "</span></li>\n                                    \n                                    <li class=\"role\">Role: <span>").concat(_response === null || _response === void 0 ? void 0 : _response.user_type, "</span></li>\n                                    <li class=\"role\">Coach: <span>").concat(_response === null || _response === void 0 || (_response$trainer$3 = _response.trainer[0]) === null || _response$trainer$3 === void 0 ? void 0 : _response$trainer$3.name, "</span></li>\n                                    <li>Location: <span>").concat(_response !== null && _response !== void 0 && _response.location ? _response === null || _response === void 0 ? void 0 : _response.location : '', "</span></li>\n                                </ul>\n                            </div>\n                            <div class=\"show-user-details__inner--mid detail-items\">\n                                <ul>\n                                ").concat(_response !== null && _response !== void 0 && _response.vision ? '<li>Vision: <span>' + (_response === null || _response === void 0 ? void 0 : _response.vision) + '</span></li>' : '', "\n                                ").concat(_response !== null && _response !== void 0 && _response.description ? '<li>Brief Description: <span>' + _response.description + '</span></li>' : '', "\n                                            \n                                </ul>\n                            </div>\n                            <div class=\"show-user-details__inner--right detail-items\">\n                                <ul>\n                                    <li class=\"profile-img\"><img src=\"").concat(_response !== null && _response !== void 0 && _response.avatar ? _response.avatar : '/images/default-face.jpg', "\" width=\"100\" height=\"100\" alt=\"profile\"></li>\n                                    <li>LinkedIn: <span>").concat(_response === null || _response === void 0 ? void 0 : _response.linkedin_url, "</span></li>\n                                    <li>Email Id: <span>").concat(_response === null || _response === void 0 ? void 0 : _response.email, "</span></li>\n                                    <li>Mobile No: <span>").concat(_response === null || _response === void 0 ? void 0 : _response.phone, "</span></li>\n                                    \n                                </ul>\n                            </div>\n                        </div>\n                        ");
      }
      if ((_response === null || _response === void 0 ? void 0 : _response.user_type) === 'trainer') {
        var _Samvaarta2;
        deepDis = "\n                        <div class=\"show-user-details__inner\">\n                            <div class=\"show-user-details__inner--left detail-items\">\n                              <ul>\n                              <li>Code: <span>".concat(_response !== null && _response !== void 0 && _response.unique_number ? _response === null || _response === void 0 ? void 0 : _response.unique_number : _response === null || _response === void 0 ? void 0 : _response.id, "</span></li>\n                                <li>Name: <span>").concat(_response !== null && _response !== void 0 && _response.name ? _response === null || _response === void 0 ? void 0 : _response.name : '', "</span></li>\n                                    <li>Date of Joining: <span>").concat((_Samvaarta2 = Samvaarta) === null || _Samvaarta2 === void 0 || (_Samvaarta2 = _Samvaarta2.common) === null || _Samvaarta2 === void 0 ? void 0 : _Samvaarta2.dateMonthYear(_response === null || _response === void 0 ? void 0 : _response.created_at), "</span></li>\n                                    \n                                    <li class=\"role\">Role: <span>").concat(_response === null || _response === void 0 ? void 0 : _response.user_type, "</span></li>                                  \n                                    <li>Location: <span>").concat(_response !== null && _response !== void 0 && _response.location ? _response === null || _response === void 0 ? void 0 : _response.location : '', "</span></li>\n                                </ul>\n                            </div>\n                            <div class=\"show-user-details__inner--mid detail-items\">\n                                <ul>\n                                ").concat(_response !== null && _response !== void 0 && _response.vision ? '<li>Vision: <span>' + (_response === null || _response === void 0 ? void 0 : _response.vision) + '</span></li>' : '', "\n                                ").concat(_response !== null && _response !== void 0 && _response.description ? '<li>Brief Description: <span>' + _response.description + '</span></li>' : '', "\n                                            \n                                </ul>\n                            </div>\n                            <div class=\"show-user-details__inner--right detail-items\">\n                                <ul>\n                                    <li class=\"profile-img\"><img src=\"").concat(_response !== null && _response !== void 0 && _response.avatar ? _response.avatar : '/images/default-face.jpg', "\" width=\"100\" height=\"100\" alt=\"profile\"></li>\n                                    <li>LinkedIn: <span>").concat(_response === null || _response === void 0 ? void 0 : _response.linkedin_url, "</span></li>\n                                    <li>Email Id: <span>").concat(_response === null || _response === void 0 ? void 0 : _response.email, "</span></li>\n                                    <li>Mobile No: <span>").concat(_response === null || _response === void 0 ? void 0 : _response.phone, "</span></li>\n                                    \n                                </ul>\n                            </div>\n                        </div>\n                      ");
        Samvaarta.system.trainerDashboard(_response === null || _response === void 0 ? void 0 : _response.users);
      }
    }
  ...
  var displayDashInfo = function displayDashInfo() {
    ...
    var paramObject = {
      url: apiUrl + 'api/' + ((_oauthUserData10 = oauthUserData) === null || _oauthUserData10 === void 0 ? void 0 : _oauthUserData10.user_type) + '/documenting-conversations/?user_id=' + userId,
      type: "GET",
      data: {
        'user_id': userId
      },
  ...
  var displayDocument = function displayDocument() {
    var _Samvaarta$common$get4, _oauthUserData11, _response2;
    var previous = '';
    var supportDoc = '';
    var interaction = '';
    var response = '';
    var userInfo = (_Samvaarta$common$get4 = Samvaarta.common.getLocalStorage('deepUserData')) === null || _Samvaarta$common$get4 === void 0 ? void 0 : _Samvaarta$common$get4.data;
    if (((_oauthUserData11 = oauthUserData) === null || _oauthUserData11 === void 0 ? void 0 : _oauthUserData11.user_type) === 'admin') {
      var _Samvaarta$common$get5;
      response = (_Samvaarta$common$get5 = Samvaarta.common.getLocalStorage('deepUserData')) === null || _Samvaarta$common$get5 === void 0 ? void 0 : _Samvaarta$common$get5.DocumentConversations;
    } else {
      var _Samvaarta$common$get6;
      response = (_Samvaarta$common$get6 = Samvaarta.common.getLocalStorage('deepUserData')) === null || _Samvaarta$common$get6 === void 0 ? void 0 : _Samvaarta$common$get6.data;
    }
    if ((_response2 = response) !== null && _response2 !== void 0 && _response2.length) {
      var _response3;
      interaction += "<table>\n            <tr class=\"user-dashboard-info__head-list\">\n                <td>S.No</td>\n                <td>Date</td>\n                <td>Transaction</td>\n                <td>Trainer</td>\n                <td>Edit/Update</td>\n            </tr>";
      (_response3 = response) === null || _response3 === void 0 || _response3.map(function (item, index) {
        var _item$session8, _oauthUserData12, _oauthUserData13, _userInfo$trainer$, _item$session9, _oauthUserData14, _oauthUserData15;
        if (item.doc_file) {
  ...
  var displayObjective = function displayObjective() {
    ...
    if (response !== null && response !== void 0 && (_response$Performance = response.PerformanceData) !== null && _response$Performance !== void 0 && _response$Performance.length) {
      var _response$Performance2, _response$Performance3, _response$Performance4;
      ...
      for (var j = 0; j < 3; j++) {
        ...
        for (var i = 0; i < (perData === null || perData === void 0 ? void 0 : perData.length); i++) {
          ppdata += "<td>".concat(perData[i].performance[j], "</td>");
        }
        pdata += "\n                    <tr>\n                        <td>".concat(perData[0].parameter[j], "</td>\n                        <td>").concat(perData[0].unit_measurement[j], "</td>\n                        <td>\n                            <table>\n                                <tr class=\"view-date-format\">\n                                    ").concat(ppdata, "\n                                </tr>\n                            </table>\n                        </td>                        \n                    </tr>\n                ");
      }
      for (var _i2 = 0; _i2 < (perData === null || perData === void 0 ? void 0 : perData.length); _i2++) {
        date += "\n                    <td width=\"5%\">".concat(perData[_i2].performance_date, "</td>\n                ");
      }
      quantitative += "\n            <div class=\"details--items quantitative\">\n                <h3>Quantitative Parameters - <span>They refer to the past, current and future performance</span></h3>\n                <h4>The following details needs to be filled up</h4>\n                <ul class=\"details--items__topics\">\n                    <li>Measurable parameters - 3</li>\n                    <li>Mention the units of measurement for example in% or unit</li>\n                    <li>Performance of the parameter over of last two month and current month Future months</li>\n                    <li>For example -\n                        <ul>\n                            <li>Parameter - Emp attrition</li>\n                            <li>Measurement - %: Performance jun - 16%, Jul - 17%, Aug - 16%</li>\n                        </ul> \n                    </li>\n                </ul>\n                <div class=\"quantitative__data\">\n                    <table class=\"complex-view1\">\n                        <thead>\n                            <tr class=\"user-dashboard-info__head-list\">\n                                <td>Parameter</td>\n                                <td>Unit of Measurement</td>\n                                <td>Performance</td>\n                            </tr>                            \n                        </thead>\n                        <tbody>\n                        <tr>\n                            <td></td>\n                            <td></td>\n                            <td>\n                                <table class=\"\">\n                                    <tbody><tr class=\"view-date-format\">\n                                      ".concat(date, "\n                                    </tr>\n                                </tbody></table>\n                            </td>\n                        </tr>                        \n                        ").concat(pdata, "\n                        </tbody>\n                    </table>\n                </div>\n            </div>\n            ");
      qualitative += "\n            <div class=\"details--items qualitative\">\n                <h3>Qualitative Parameters - <span>They refer to the behavioural shift you desire</span></h3>\n                <h4>The following details needs to be filled up</h4>\n                <ul class=\"details--items__topics\">\n                    <li>Mention the parameter</li>\n                    <li>Give a brief description of the parameter</li>\n                    <li>They should be influencing the quantitative parameter</li>\n                    <li>For Example \n                        <ul>\n                            <li>Parameter - Customer Relationship</li>\n                            <li>Brief Description - Develop and maintain strong relationships with key clients and accounts</li>\n                        </ul>\n                    </li>\n                </ul>\n                <div class=\"qualitative__data\">\n                    <table class=\"light-view\">\n                        <thead>\n                            <tr class=\"user-dashboard-info__head-list\">\n                                <td>Parameter</td>\n                                <td>Brief Description</td>\n                            </tr>\n                        </thead>\n                        <tbody>\n                            ".concat(performanceDataOther, "\n                        </tbody>\n                    </table>\n                </div>\n            </div>\n            <div class=\"form-elm-section btn-center-align marg-t10\">\n                <button onclick=\"Samvaarta.setGetUserDashboard.desiredObjectiveStatus(1, ").concat(response === null || response === void 0 || (_response$Performance3 = response.PerformanceData[0]) === null || _response$Performance3 === void 0 ? void 0 : _response$Performance3.user_id, ")\" class=\"btn\">Approve</button>\n                <button onclick=\"Samvaarta.setGetUserDashboard.desiredObjectiveStatus(2, ").concat(response === null || response === void 0 || (_response$Performance4 = response.PerformanceData[0]) === null || _response$Performance4 === void 0 ? void 0 : _response$Performance4.user_id, ")\" class=\"btn\">Reject</button>\n            </div>\n            ");
      objective += "\n                ".concat(quantitative, "\n                ").concat(qualitative, "\n            ");
    } else {
  ...
  var displayOutcomes = function displayOutcomes() {
    ...
    if (response !== null && response !== void 0 && (_response$LearningOut = response.LearningOutcomes) !== null && _response$LearningOut !== void 0 && _response$LearningOut.length) {
      var _response$LearningOut2, _response$LearningOut3, _response$LearningOut4;
      ...
      outcome = "\n        <div class=\"details\">\n            <h3>Desired Outcomes</h3>\n            <p>Desired outcomes refers to the state you desire at the end of the period                    </p>\n            <div class=\"details--items outcomes\">\n                <h4>The following details needs to be filled up</h4>\n                <ul class=\"details--items__topics\">\n                    <li>Mention the parameter</li>\n                    <li>Describe the outcome you like. This will include the way you will feel, hear, say and do after a desired a period of time</li>\n                    <li>For example\n                        <ul>\n                            <li>Parameter - Manager Relationship</li>\n                            <li>Brief Description - My manager is talking is trusting me by giving important tasks beyond the KRAs</li>\n                        </ul>\n                    </li>\n                </ul>\n                <div class=\"outcomes__data\">\n                    <table class=\"light-view\">\n                        <thead>\n                            <tr class=\"user-dashboard-info__head-list\">\n                                <td>Parameter</td>\n                                <td>Brief Description</td>\n                            </tr>\n                        </thead>\n                        <tbody>\n                            ".concat(outcomesData, "\n                        </tbody>\n                    </table>\n                    <div class=\"form-elm-section btn-center-align marg-t10 \">\n                        <button onclick=\"Samvaarta.setGetUserDashboard.desiredOutcomesStatus(1, ").concat(response === null || response === void 0 || (_response$LearningOut3 = response.LearningOutcomes[0]) === null || _response$LearningOut3 === void 0 ? void 0 : _response$LearningOut3.id, ")\" class=\"btn\">Approve</button>\n                        <button onclick=\"Samvaarta.setGetUserDashboard.desiredOutcomesStatus(2, ").concat(response === null || response === void 0 || (_response$LearningOut4 = response.LearningOutcomes[0]) === null || _response$LearningOut4 === void 0 ? void 0 : _response$LearningOut4.id, ")\" class=\"btn\">Reject</button>\n                    </div>\n                </div>\n            </div>\n            \n        </div>\n        ");
    } else {
  ...
  var displayClosure = function displayClosure() {
    ...
    if (response !== null && response !== void 0 && (_response$ClosureUser = response.ClosureUserExperinces) !== null && _response$ClosureUser !== void 0 && _response$ClosureUser.length) {
      var _response$ClosureUser2, _oauthUserData16, _oauthUserData17, _oauthUserData18, _response$ClosureTrai;
      ...
      closureTrainer += "\n                <div class=\"details--items manager-closure-input\">\n                <h3>Manager Experience</h3>";
      closureTrainer += "\n                    <ul class=\"list-view\">\n                        <li>\n                            <label for=\"manager_enjoyed\">I enjoyed....</label>\n                            <textarea ".concat(((_oauthUserData16 = oauthUserData) === null || _oauthUserData16 === void 0 ? void 0 : _oauthUserData16.user_type) === 'admin' ? 'readonly' : '', " rows=\"2\" cols=\"50\" type=\"text\" id=\"manager_enjoyed\" value=\"\" class=\"input_txt_box\"></textarea>\n                        </li>\n                        <li>\n                            <label for=\"manager_wished\">I wish....</label>\n                            <textarea ").concat(((_oauthUserData17 = oauthUserData) === null || _oauthUserData17 === void 0 ? void 0 : _oauthUserData17.user_type) === 'admin' ? 'readonly' : '', " rows=\"2\" cols=\"50\" type=\"text\" id=\"manager_wished\" value=\"\" class=\"input_txt_box\"></textarea>\n                        </li>\n                    </ul>\n                </div>\n                <div class=\"form-elm-section ").concat(((_oauthUserData18 = oauthUserData) === null || _oauthUserData18 === void 0 ? void 0 : _oauthUserData18.user_type) === 'admin' ? 'hide' : '', "\">\n                    <button class=\"btn\" onclick=\"Samvaarta.deepDisplayUser.trainerClosureComment(").concat(userId, ")\">Submit</button>         \n                </div>\n            ");
  ...
  var displayTrainerDashInfo = function displayTrainerDashInfo() {
    var paramObject = {
...
document.addEventListener("readystatechange", function (event) {
  ...
  if (event.target.readyState === "complete") {
    unvielImg();
    setTimeout(function () {
      var _oauthUserData20, _oauthUserData21;
      if (Samvaarta.globalVar.is_loggedin) {
        var _oauthUserData19;
        ...
        if (((_oauthUserData19 = oauthUserData) === null || _oauthUserData19 === void 0 ? void 0 : _oauthUserData19.user_type) === 'admin') {
          Samvaarta.system.enquiriesDetail();
        }
      }
      if ($('.deep-user-route').length && ((_oauthUserData20 = oauthUserData) === null || _oauthUserData20 === void 0 ? void 0 : _oauthUserData20.user_type) !== 'user') {
        Samvaarta.deepDisplayUser.displayDashInfo();
      }
      if ($('.deep-trainer-route').length && ((_oauthUserData21 = oauthUserData) === null || _oauthUserData21 === void 0 ? void 0 : _oauthUserData21.user_type) !== 'user') {
