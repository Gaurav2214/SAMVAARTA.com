...
Samvaarta.deepDisplayUser = function (_window$location, _window$location$path) {
  ...
  var displayDocument = function displayDocument() {
    var _Samvaarta$common$get4, _oauthUserData7, _response2;
    var previous = '';
    var supportDoc = '';
    var interaction = '';
    var response = '';
    ...
    if (((_oauthUserData7 = oauthUserData) === null || _oauthUserData7 === void 0 ? void 0 : _oauthUserData7.user_type) === 'admin') {
    ...
    if ((_response2 = response) !== null && _response2 !== void 0 && _response2.length) {
      ...
      (_response3 = response) === null || _response3 === void 0 || _response3.map(function (item, index) {
        var _item$session8, _oauthUserData8, _oauthUserData9, _userInfo$trainer$, _item$session9, _oauthUserData10, _oauthUserData11;
        if (item.doc_file) {
  ...
  var displayClosure = function displayClosure() {
    ...
    if (response !== null && response !== void 0 && (_response$ClosureUser = response.ClosureUserExperinces) !== null && _response$ClosureUser !== void 0 && _response$ClosureUser.length) {
      var _response$ClosureUser2, _oauthUserData12, _oauthUserData13, _oauthUserData14, _response$ClosureTrai;
      ...
      closureTrainer += "\n                <div class=\"details--items manager-closure-input\">\n                <h3>Manager Experience</h3>";
      closureTrainer += "\n                    <ul class=\"list-view\">\n                        <li>\n                            <label for=\"manager_enjoyed\">I enjoyed....</label>\n                            <textarea ".concat(((_oauthUserData12 = oauthUserData) === null || _oauthUserData12 === void 0 ? void 0 : _oauthUserData12.user_type) === 'admin' ? 'readonly' : '', " rows=\"2\" cols=\"50\" type=\"text\" id=\"manager_enjoyed\" value=\"\" class=\"input_txt_box\"></textarea>\n                        </li>\n                        <li>\n                            <label for=\"manager_wished\">I wish....</label>\n                            <textarea ").concat(((_oauthUserData13 = oauthUserData) === null || _oauthUserData13 === void 0 ? void 0 : _oauthUserData13.user_type) === 'admin' ? 'readonly' : '', " rows=\"2\" cols=\"50\" type=\"text\" id=\"manager_wished\" value=\"\" class=\"input_txt_box\"></textarea>\n                        </li>\n                    </ul>\n                </div>\n                <div class=\"form-elm-section ").concat(((_oauthUserData14 = oauthUserData) === null || _oauthUserData14 === void 0 ? void 0 : _oauthUserData14.user_type) === 'admin' ? 'hide' : '', "\">\n                    <button class=\"btn\" onclick=\"Samvaarta.deepDisplayUser.trainerClosureComment(").concat(userId, ")\">Submit</button>         \n                </div>\n            ");
...
document.addEventListener("readystatechange", function (event) {
  ...
  if (event.target.readyState === "complete") {
    unvielImg();
    setTimeout(function () {
      var _oauthUserData16;
      if (Samvaarta.globalVar.is_loggedin) {
        var _oauthUserData15;
        ...
        if (((_oauthUserData15 = oauthUserData) === null || _oauthUserData15 === void 0 ? void 0 : _oauthUserData15.user_type) === 'admin') {
          Samvaarta.system.enquiriesDetail();
        }
      }
      if ($('.deep-user-route').length && ((_oauthUserData16 = oauthUserData) === null || _oauthUserData16 === void 0 ? void 0 : _oauthUserData16.user_type) !== 'user') {
