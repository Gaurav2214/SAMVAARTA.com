...
Samvaarta.setGetUserDashboard = function () {
  ...
  var qualitativeData = function qualitativeData(response) {
    var qualityData = '';
    for (var i = 0; i < 3; i++) {
      qualityData += "\n            <tr>\n                <td>\n                    <input ".concat(response !== null && response !== void 0 && response.qualitative ? 'readonly' : '', " id=\"qualitative_param_").concat(i, "\" class=\"input_txt_box\" type=\"text\" value=\"\" />\n                    <p id=\"qualitative_param_").concat(i, "_err\" class=\"error\"></p>\n                </td>\n                <td>\n                    <textarea ").concat(response !== null && response !== void 0 && response.qualitative ? 'readonly' : '', " id=\"qualitative_desc_").concat(i, "\" class=\"input_txt_box\" type=\"text\" value=\"\" ></textarea>\n                    <p id=\"qualitative_desc_").concat(i, "_err\" class=\"error\"></p>\n                </td>\n            </tr>\n            ");
    }
