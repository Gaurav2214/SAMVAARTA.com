                ...
                previous += `<tr class="pre-tracs-data">
                    ...
                    <div class="update-transaction-container hide" id="edit-doc-${item?.id}" data-docId="${item?.id}" data-session="${item?.session?.session_id}">
                        ...
                        <script>
                            ...
                            document.getElementById('user_focus_${item.id}').value = '${convertTextWithLineBreaks(item?.focus_of_the_day)}';
                            document.getElementById('user_last_commitment_${item.id}').value = '${convertTextWithLineBreaks(item?.last_week_comments)}';
                            document.getElementById('user_conversation_${item.id}').value = '${convertTextWithLineBreaks(item?.today_conversion)}';
                            document.getElementById('user_week_commitment_${item.id}').value = '${convertTextWithLineBreaks(item?.feedback)}';
